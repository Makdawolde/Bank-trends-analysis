...
## **Project Overview**
This project analyzes banking deposit trends to identify factors influencing customer behavior. Using a structured approach with data cleaning, visualization, and predictive modeling, I have extracted meaningful insights that can help financial institutions optimize their strategies.
